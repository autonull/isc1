...
describe('Reputation System', () => {
  ...
  it('starts at 0.5 with no history', () => {
    const score = calculateReputation([], Date.now());
  ...
  it('increases with successful interactions', () => {
    ...
    const score = calculateReputation(interactions, now);
  ...
  it('clamps to bounds [0, 1]', () => {
    ...
    const maxScore = calculateReputation(interactions, now);
    ...
    const minScore = calculateReputation(badInteractions, now);
